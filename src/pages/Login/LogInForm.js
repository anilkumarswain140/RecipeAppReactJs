...
const Login = () => {
    ...
    return (
        <div className="flex md:w-1/1 justify-center py-10 pt-12 items-center bg-white" lang="en">
            <form
            ...
            >
                <h1
                    id="login-form"
                    className="text-gray-800 font-bold text-2xl mb-1 text-center"
                    tabindex="0"
                >
                    Hello Again!
                </h1>
                <p
                    className="text-sm font-normal text-gray-600 mb-7 text-center"
                    tabindex="0"
                >
                    Welcome Back
                </p>
                ...
                <div className="mb-4">
                    ...
                    {errors.email && (
                        <p className="text-red-500 text-sm mt-1 ml-2" tabindex="0">
                            {errors.email}
                        </p>
                    )}
                </div>
                ...
                {error && (
                    <p className="text-red-500 font-semibold text-center mb-4" tabindex="0">
                        {error}
                    </p>
                )}
