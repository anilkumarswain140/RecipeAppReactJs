                ...
                <form className="bg-white w-full max-w-md px-4">
                    ...
                    <div className="flex flex-col mb-4">
                        <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                            ...
                            <input className="pl-2 outline-none border-none text-box" type="text" name="username" placeholder="Username" value={formData.username} onChange={handleChange} />
                        </div>
                    ...
                    <div className="flex flex-col mb-4">
                        <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                            ...
                            <input className="pl-2 outline-none border-none text-box " type="text" name="email" placeholder="Email Address" value={formData.email} onChange={handleChange} />
                        </div>
                    ...
                    <div className="flex flex-col mb-4">
                        <div className="flex items-center border-2 py-2 px-3 rounded-2xl">
                            ...
                            <input className="pl-2 outline-none border-none text-box" type="password" name="password" placeholder="Password" value={formData.password} onChange={handleChange} />
                        </div>
